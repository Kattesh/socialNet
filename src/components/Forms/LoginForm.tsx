...
const formikInitial = { login: '', password: '', remember: false, captcha: '', error: '' };

export const LoginForm = (props: LoginFormTypeProps) => {
    const { onSubmit, captcha } = props;

    return (
        <Formik initialValues={formikInitial} validateOnBlur onSubmit={onSubmit} validationSchema={validationSchema}>
